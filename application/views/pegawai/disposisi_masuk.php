<div id="page-wrapper">
	<div class="graphs">
		<h3 class="blank1">Disposisi Masuk Surat</h3>
		<div class="xs tabls">
			...
			<table class="table">
				<a href="#" class="btn btn-info btn-sm" target="_blank" data-toggle="modal" data-target="#modal_add">Tambah Disposisi Masuk</a>
				<thead>
					<tr>
						<th>No</th>
						<th>Unit Pengirim</th>
